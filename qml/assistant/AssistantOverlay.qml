    ...
    function _askWithContext(dataBlock, unused) {
        ...
        if (webOn)
            persona += "\nYou have live web search. AUTOMATICALLY use it for any real-time or factual question "
                + "you don't already know — the weather in a city, current events, a score, a price, 'what is X', "
                + "'who is Y', a bean or roaster's tasting notes, roast dates, brewing guides, gear — instead of "
                + "guessing or saying you can't check. Do NOT ask permission first ('want me to look that up?'); "
                + "just search, then answer briefly from what you find (at most once or twice per reply). BE "
