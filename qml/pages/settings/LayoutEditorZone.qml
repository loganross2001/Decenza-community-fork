...
Rectangle {
                    ...
                    contentItem: ColumnLayout {
                        ...
                        ListView {
                            ...
                            readonly property var catalog: [
                                ...
                                { type: "steamPlan", cat: 1, label: TranslationManager.translate("layoutEditor.widgetSteamPlan", "Steam Plan") },
                                ...
                                { type: "plan", cat: 1, label: TranslationManager.translate("layoutEditor.widgetPlan", "Plan (page-aware)") },
    ...
    function getItemDisplayName(type) {
        var names = {
            ...
            "steamPlan": TranslationManager.translate("layoutEditor.chipSteamPlan", "Steam Plan"),
            "plan": TranslationManager.translate("layoutEditor.chipPlan", "Plan"),
