...
Page {
    ...
    readonly property string pageTitle: TranslationManager.translate("dialingassistant.title", "AI Recommendation")
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                AccessibleButton {
                    ...
                    accessibleName: TranslationManager.translate("dialingAssistant.sendFollowUpQuestion", "Send follow-up question about dialing in")
