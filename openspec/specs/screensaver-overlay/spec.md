# screensaver-overlay Specification

## Purpose
Governs the optional overlay widgets (Clock, Water Level, Shot Plan, Battery, Link Button) that can be shown on top of screensaver backgrounds, their per-background/global scoping, and anti-burn-in behavior.
