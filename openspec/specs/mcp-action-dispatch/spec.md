# mcp-action-dispatch Specification

## Purpose
The verb-enum tool convention: how a merged MCP tool declares its actions, and how access level, rate limiting and confirmation resolve per action rather than per tool name.
