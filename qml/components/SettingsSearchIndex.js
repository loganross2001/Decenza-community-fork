...
function getSearchEntries(tr) {
    ...
    return [
        ...
        { tabId: "machine", cardId: "maintenance",
          title: tr("settings.maintenance.title", "Maintenance"),
          description: tr("settings.maintenance.description", "Keep your machine clean and ready for storage."),
